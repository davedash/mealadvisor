 ...
 * @version    SVN: $Id: sfGuardUser.php 1949 2006-09-05 14:40:20Z fabien $
 */
class sfGuardUser extends BasesfGuardUser
{
  ...
  public function getProfile()
  {
    if (null === $this->profile)
    {
      ...
      if (!$foreignKeyColumn)
      {
        throw new sfException(sprintf('The user profile class "%s" does not contain a "%s" column.', $foreignKeyName));
      }
  ...
  public function getAllPermissions()
  {
    if (!$this->groupPermissions)
    {
      ...
      $this->groupPermissions = array_merge($this->groupPermissions, $this->getPermissions());
    }
