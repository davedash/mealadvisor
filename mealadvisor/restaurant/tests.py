...
class AjaxTest(TransactionTestCase):
    ...
    def setUp(self):
        ...
        qsa      = {'username':'davedash.livejournal.com', 'password':'sexy'}
        response = self.client.post('/login', qsa, follow=True)
        # print dir(response)
        # ['__class__', '__contains__', '__delattr__', '__delitem__', '__dict__', '__doc__',
        # '__getattribute__', '__getitem__', '__hash__', '__init__', '__iter__', '__module__',
        # '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__setitem__',
        # '__str__', '__weakref__', '_charset', '_container', '_convert_to_ascii', '_get_content',
