...
require_once dirname(__FILE__) . "/../OpenID/HMACSHA1.php";
require_once dirname(__FILE__) . "/../OpenID/Association.php";
require_once dirname(__FILE__) . "/../OpenID/AuthenticationRequest.php";
...
class Auth_OpenID_Consumer {
     ...
     */
    public $nonce_chrs = Auth_OpenID_DEFAULT_NONCE_CHRS;
     ...
     * timing out.
     */
    public $token_lifetime = Auth_OpenID_DEFAULT_TOKEN_LIFETIME;
