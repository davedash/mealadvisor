...
/**
 * This class adds structure of 'menuitem_rating' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 * @package model.map
 */	
class MenuItemRatingMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'model.map.MenuItemRatingMapBuilder';	
    ...
    public function doBuild()
    {
		...
		$tMap = $this->dbMap->addTable('menuitem_rating');
		$tMap->setPhpName('MenuItemRating');
