...
/**
 * This class adds structure of 'RestaurantTag' table to 'propel' DatabaseMap object.
 *
 *
 *
...
class QuestionTagMapBuilder {
	 ...
	 */
	const CLASS_NAME = 'model.map.QuestionTagMapBuilder';	
    ...
    public function doBuild()
    {
		...
		$tMap = $this->dbMap->addTable('RestaurantTag');
