...
/**
 * This class adds structure of 'restaurant_version' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 * @package model.map
 */	
class RestaurantVersionMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'model.map.RestaurantVersionMapBuilder';	
    ...
    public function doBuild()
    {
		...
		$tMap = $this->dbMap->addTable('restaurant_version');
		$tMap->setPhpName('RestaurantVersion');

		$tMap->setUseIdGenerator(true);

		$tMap->addPrimaryKey('ID', 'Id', 'int', CreoleTypes::INTEGER, true, null);

		$tMap->addColumn('CHAIN', 'Chain', 'boolean', CreoleTypes::BOOLEAN, false);
