...
/**
 * This class adds structure of 'menuitem_note' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 * @package model.map
 */	
class MenuItemNoteMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'model.map.MenuItemNoteMapBuilder';	
    ...
    public function doBuild()
    {
		...
		$tMap = $this->dbMap->addTable('menuitem_note');
		$tMap->setPhpName('MenuItemNote');
