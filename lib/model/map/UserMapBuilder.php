...
class UserMapBuilder {
    ...
    public function doBuild()
    {
		...
		$tMap->addColumn('USERID', 'Userid', 'string', CreoleTypes::VARCHAR, false);

		$tMap->addColumn('EMAIL', 'Email', 'string', CreoleTypes::VARCHAR, false);

		$tMap->addColumn('PASSWORD_MD5', 'PasswordMd5', 'string', CreoleTypes::VARCHAR, false);

		$tMap->addColumn('OPEN_ID', 'OpenId', 'boolean', CreoleTypes::BOOLEAN, false);
