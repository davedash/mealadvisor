...
/**
 * This class adds structure of 'menu_item' table to 'propel' DatabaseMap object.
 *
 *
 *
...
class MenuItemMapBuilder {
	 ...
	 */
	const CLASS_NAME = 'model.map.MenuItemMapBuilder';	
    ...
    public function doBuild()
    {
		...
		$tMap->addForeignKey('VERSION_ID', 'VersionId', 'int', CreoleTypes::INTEGER, 'menuitem_version', 'ID', false, null);
