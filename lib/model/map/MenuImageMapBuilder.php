...
/**
 * This class adds structure of 'menu_image' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 * @package model.map
 */	
class MenuImageMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'model.map.MenuImageMapBuilder';	
    ...
    public function doBuild()
    {
		...
		$tMap = $this->dbMap->addTable('menu_image');
		$tMap->setPhpName('MenuImage');
		...
		$tMap->addColumn('FILENAME', 'Filename', 'string', CreoleTypes::VARCHAR, false);
