...
abstract class BaseCountryPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (CountryPeer::ISO, CountryPeer::NAME, CountryPeer::PRINTABLE_NAME, CountryPeer::ISO3, CountryPeer::NUMCODE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (CountryPeer::ISO => 0, CountryPeer::NAME => 1, CountryPeer::PRINTABLE_NAME => 2, CountryPeer::ISO3 => 3, CountryPeer::NUMCODE => 4, ),
	...
	public static function getMapBuilder()
	{
		...
		return BasePeer::getMapBuilder('model.map.CountryMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(country.ISO)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT country.ISO)';
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('model.map.CountryMapBuilder');
}
