...
include_once 'lib/model/RestaurantRatingPeer.php';

/**
 * Base class that represents a row from the 'restaurant_rating' table.
 *
 * 
 *
 * @package model.om
 */
abstract class BaseRestaurantRating extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RestaurantRatingPeer::ID;
		}
	...
	public function setRestaurantId($v)
	{
		...
		if ($this->restaurant_id !== $v) {
			...
			$this->modifiedColumns[] = RestaurantRatingPeer::RESTAURANT_ID;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = RestaurantRatingPeer::VALUE;
		}
	...
	public function setLocationId($v)
	{
		...
		if ($this->location_id !== $v) {
			$this->location_id = $v;
			$this->modifiedColumns[] = RestaurantRatingPeer::LOCATION_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = RestaurantRatingPeer::USER_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = RestaurantRatingPeer::CREATED_AT;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->value = $rs->getInt($startcol + 2);
			...
			return $startcol + 6; // 6 = RestaurantRatingPeer::NUM_COLUMNS - RestaurantRatingPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating RestaurantRating object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			RestaurantRatingPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RestaurantRatingPeer::doInsert($this, $con);
					...
					$affectedRows += RestaurantRatingPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RestaurantRatingPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RestaurantRatingPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RestaurantRatingPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RestaurantRatingPeer::ID)) $criteria->add(RestaurantRatingPeer::ID, $this->id);
		if ($this->isColumnModified(RestaurantRatingPeer::RESTAURANT_ID)) $criteria->add(RestaurantRatingPeer::RESTAURANT_ID, $this->restaurant_id);
		if ($this->isColumnModified(RestaurantRatingPeer::VALUE)) $criteria->add(RestaurantRatingPeer::VALUE, $this->value);
		if ($this->isColumnModified(RestaurantRatingPeer::LOCATION_ID)) $criteria->add(RestaurantRatingPeer::LOCATION_ID, $this->location_id);
		if ($this->isColumnModified(RestaurantRatingPeer::USER_ID)) $criteria->add(RestaurantRatingPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(RestaurantRatingPeer::CREATED_AT)) $criteria->add(RestaurantRatingPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RestaurantRatingPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param object $copyObj An object of RestaurantRating (or compatible) type.
	 ...
	 *
	 * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return RestaurantRating Clone of current object.
	 * @throws PropelException
	 */
	 ...
	 *
	 * @return RestaurantRatingPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RestaurantRatingPeer();
		}
		return self::$peer;
	}
