...
// actual class may be a subclass -- as returned by QuestionTagPeer::getOMClass()
include_once 'lib/model/QuestionTag.php';

/**
 * Base static class for performing query and update operations on the 'RestaurantTag' table.
 *
 * 
 *
 * @package model.om
...
abstract class BaseQuestionTagPeer {
	...
	const TABLE_NAME = 'RestaurantTag';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'model.QuestionTag';
	...
	const RESTAURANT_ID = 'RestaurantTag.RESTAURANT_ID';

	/** the column name for the USER_ID field */
	const USER_ID = 'RestaurantTag.USER_ID';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'RestaurantTag.CREATED_AT';

	/** the column name for the TAG field */
	const TAG = 'RestaurantTag.TAG';

	/** the column name for the NORMALIZED_TAG field */
	const NORMALIZED_TAG = 'RestaurantTag.NORMALIZED_TAG';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (QuestionTagPeer::RESTAURANT_ID, QuestionTagPeer::USER_ID, QuestionTagPeer::CREATED_AT, QuestionTagPeer::TAG, QuestionTagPeer::NORMALIZED_TAG, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (QuestionTagPeer::RESTAURANT_ID => 0, QuestionTagPeer::USER_ID => 1, QuestionTagPeer::CREATED_AT => 2, QuestionTagPeer::TAG => 3, QuestionTagPeer::NORMALIZED_TAG => 4, ),
	...
	public static function getMapBuilder()
	{
		...
		return BasePeer::getMapBuilder('model.map.QuestionTagMapBuilder');
	}
	/**
	 ...
	 * @param string $column The column name for current table. (i.e. QuestionTagPeer::COLUMN_NAME).
	 * @return string
	 */
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(QuestionTagPeer::RESTAURANT_ID);
	...
	const COUNT = 'COUNT(RestaurantTag.RESTAURANT_ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT RestaurantTag.RESTAURANT_ID)';
	...
	public static function doCountJoinRestaurant(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(QuestionTagPeer::RESTAURANT_ID, RestaurantPeer::ID);
	...
	/**
	 * Selects a collection of QuestionTag objects pre-filled with their Restaurant objects.
	 *
	 * @return array Array of QuestionTag objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinRestaurant(Criteria $c, $con = null)
	{
		...
		$c->addJoin(QuestionTagPeer::RESTAURANT_ID, RestaurantPeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addQuestionTag($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initQuestionTags();
				$obj2->addQuestionTag($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	/**
	 * Selects a collection of QuestionTag objects pre-filled with their User objects.
	 *
	 * @return array Array of QuestionTag objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	/**
	 * Selects a collection of QuestionTag objects pre-filled with all related objects.
	 *
	 * @return array Array of QuestionTag objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addQuestionTag($obj1); // CHECKME
					break;
				}
			}
	...
	/**
	 * Selects a collection of QuestionTag objects pre-filled with all related objects except Restaurant.
	 *
	 * @return array Array of QuestionTag objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	/**
	 * Selects a collection of QuestionTag objects pre-filled with all related objects except User.
	 *
	 * @return array Array of QuestionTag objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	/**
	 * Method perform an INSERT on the database, given a QuestionTag or Criteria object.
	 *
	 * @param mixed $values Criteria or QuestionTag object containing data that is used to create the INSERT statement.
	 * @param Connection $con the connection to use
	...
	public static function doInsert($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from QuestionTag object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a QuestionTag or Criteria object.
	 *
	 * @param mixed $values Criteria or QuestionTag object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(QuestionTagPeer::RESTAURANT_ID);
			$selectCriteria->add(QuestionTagPeer::RESTAURANT_ID, $criteria->remove(QuestionTagPeer::RESTAURANT_ID), $comparison);
		...
		} else { // $values is QuestionTag object
	...
	/**
	 * Method to DELETE all rows from the RestaurantTag table.
	 *
	 * @return int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a QuestionTag or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof QuestionTag) {
			...
			$criteria->add(QuestionTagPeer::RESTAURANT_ID, $vals[0], Criteria::IN);
	...
	/**
	 * Validates all modified columns of given QuestionTag object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param QuestionTag $obj The object to validate.
	...
	public static function retrieveByPK( $restaurant_id, $user_id, $normalized_tag, $con = null) {
		...
		$criteria->add(QuestionTagPeer::RESTAURANT_ID, $restaurant_id);
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('model.map.QuestionTagMapBuilder');
}
