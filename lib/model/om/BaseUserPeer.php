...
abstract class BaseUserPeer {
	...
	/** the column name for the PASSWORD_MD5 field */
	const PASSWORD_MD5 = 'user.PASSWORD_MD5';

	/** the column name for the OPEN_ID field */
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Userid', 'Email', 'PasswordMd5', 'OpenId', 'UpdatedAt', 'CreatedAt', ),
		BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::USERID, UserPeer::EMAIL, UserPeer::PASSWORD_MD5, UserPeer::OPEN_ID, UserPeer::UPDATED_AT, UserPeer::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'userid', 'email', 'password_md5', 'open_id', 'updated_at', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Userid' => 1, 'Email' => 2, 'PasswordMd5' => 3, 'OpenId' => 4, 'UpdatedAt' => 5, 'CreatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::USERID => 1, UserPeer::EMAIL => 2, UserPeer::PASSWORD_MD5 => 3, UserPeer::OPEN_ID => 4, UserPeer::UPDATED_AT => 5, UserPeer::CREATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'userid' => 1, 'email' => 2, 'password_md5' => 3, 'open_id' => 4, 'updated_at' => 5, 'created_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::PASSWORD_MD5);

		$criteria->addSelectColumn(UserPeer::OPEN_ID);
