...
include_once 'lib/model/RestaurantTagPeer.php';

/**
 * Base class that represents a row from the 'restaurant_tag' table.
 *
 * 
 *
 * @package model.om
 */
abstract class BaseRestaurantTag extends BaseObject  implements Persistent {
	...
	public function setRestaurantId($v)
	{
		...
		if ($this->restaurant_id !== $v) {
			...
			$this->modifiedColumns[] = RestaurantTagPeer::RESTAURANT_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = RestaurantTagPeer::USER_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = RestaurantTagPeer::CREATED_AT;
		}
	...
	public function setTag($v)
	{
		...
		if ($this->tag !== $v) {
			$this->tag = $v;
			$this->modifiedColumns[] = RestaurantTagPeer::TAG;
		}
	...
	public function setNormalizedTag($v)
	{
		...
		if ($this->normalized_tag !== $v) {
			...
			$this->modifiedColumns[] = RestaurantTagPeer::NORMALIZED_TAG;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 5; // 5 = RestaurantTagPeer::NUM_COLUMNS - RestaurantTagPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating RestaurantTag object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			RestaurantTagPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RestaurantTagPeer::doInsert($this, $con);
					...
					$affectedRows += RestaurantTagPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RestaurantTagPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RestaurantTagPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RestaurantTagPeer::getFieldNames($keyType);
		$result = array(
	...
	{
		$criteria = new Criteria(RestaurantTagPeer::DATABASE_NAME);

		if ($this->isColumnModified(RestaurantTagPeer::RESTAURANT_ID)) $criteria->add(RestaurantTagPeer::RESTAURANT_ID, $this->restaurant_id);
		if ($this->isColumnModified(RestaurantTagPeer::USER_ID)) $criteria->add(RestaurantTagPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(RestaurantTagPeer::CREATED_AT)) $criteria->add(RestaurantTagPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(RestaurantTagPeer::TAG)) $criteria->add(RestaurantTagPeer::TAG, $this->tag);
		if ($this->isColumnModified(RestaurantTagPeer::NORMALIZED_TAG)) $criteria->add(RestaurantTagPeer::NORMALIZED_TAG, $this->normalized_tag);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RestaurantTagPeer::RESTAURANT_ID, $this->restaurant_id);
		$criteria->add(RestaurantTagPeer::USER_ID, $this->user_id);
		$criteria->add(RestaurantTagPeer::NORMALIZED_TAG, $this->normalized_tag);
	 ...
	 * objects.
	 *
	 * @param object $copyObj An object of RestaurantTag (or compatible) type.
	 ...
	 *
	 * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return RestaurantTag Clone of current object.
	 * @throws PropelException
	 */
	 ...
	 *
	 * @return RestaurantTagPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RestaurantTagPeer();
		}
		return self::$peer;
	}
