 ...
 * @version    SVN: $Id: sfAtom1Feed.class.php 1054 2006-03-26 18:23:26Z fabien $
 */
class sfAtom1Feed extends sfFeed
{
  ...
  private function getFeedElements()
  {
    ...
    foreach ($this->getItems() as $item)
    {
      ...
      $xml[] = '  <link href="'.sfContext::getInstance()->getController()->genUrl($this->getItemFeedLink($item), true).'"></link>';
